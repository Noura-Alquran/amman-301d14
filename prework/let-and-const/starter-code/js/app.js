...
function displayPics(){
  ...
  // Because with let, the scope of the variable rando is limited to the block in which it is declared(inside the while), while when the variable rando was declared with var,it has global scope. So when I moved the console statement to the variable scope inside the while statement, this fixed the error.
  console.log(viewed);
